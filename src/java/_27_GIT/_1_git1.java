...
public class _1_git1 { // Это такой инструмент, при помощи которого мы отправляем в удаленный репозиторий .
...
// 3) git add * : добавляет все классы проекта в наш локальный репазиторий (все классы стали зелеными,зеленые - отслеживаемые гитом)
